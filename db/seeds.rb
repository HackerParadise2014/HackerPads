...
Location.create(:name => 'North-West Hanoi', :city => 'Hoi An', :ctry => 'VN', 
  ...
  # :low_season_start => DateTime.strptime("09/01/2009 17:00", "%m/%d/%Y"), 
  # :low_season_end => DateTime.strptime("09/01/2009 17:00", "%m/%d/%Y"), 
  # :high_season_start => DateTime.strptime("09/01/2009 17:00", "%m/%d/%Y"), 
  # :high_season_end => DateTime.strptime("09/01/2009 17:00", "%m/%d/%Y"), 
